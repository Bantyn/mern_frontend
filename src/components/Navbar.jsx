  ...
  return (
    <motion.nav
      ...
      className="
        ...
        fixed left-0 right-0 w-[80%] mx-auto px-10 mb-3 shadow-2xl shadow-purple-600/10  rounded-b-full overflow-hidden
      "
    >
      ...
      >
        <div className="flex flex-col gap-4 text-center  pb-4 text-gray-300 text-lg ">
          ...
          {["Home", "About", "Contact", "Upload", "Support","Logout"].map((item) => (
            <Link
              ...
              className="py-2 border-b border-white/10 hover:text-white transition"
            >
              {item}
            </Link>
          ))}
